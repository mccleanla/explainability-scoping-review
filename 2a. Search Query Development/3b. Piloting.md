...
Used IEE and ACM to pilot study as both these databases were expected to show a mix of technical articles and HCI studies.  The search terms were tuned primarily based on these databases and then tested with the remainder.
